...
Install the [`asusctl-gex`](https://extensions.gnome.org/extension/4320/asusctl-gex/) extension to control certain features of the hardware. Learn more [here](https://gitlab.com/asus-linux/asusctl).
...
```bash
$ rpm-ostree install gnome-shell-extension-pop-shell
$ reboot
```
